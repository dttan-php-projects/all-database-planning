...
--
-- Table structure for table `vnso_tmp`
--

DROP TABLE IF EXISTS `vnso_tmp`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vnso_tmp` (
  ...
  `VIRABLE_BREAKDOWN_INSTRUCTIONS` text,
  ...
  `D` varchar(45) NOT NULL DEFAULT '1',
...
-- Dump completed on 2022-03-26 21:36:23
