...
--
-- Table structure for table `prepress_planning_prepress`
--

DROP TABLE IF EXISTS `prepress_planning_prepress`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prepress_planning_prepress` (
  ...
  `COMMENT` varchar(545) DEFAULT NULL,
  ...
  `INTERNAL_ITEM` varchar(150) DEFAULT NULL,
...
-- Dump completed on 2022-03-26 21:38:10
