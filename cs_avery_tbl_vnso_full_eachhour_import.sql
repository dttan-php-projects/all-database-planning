...
--
-- Table structure for table `tbl_vnso_full_eachhour_import`
--

DROP TABLE IF EXISTS `tbl_vnso_full_eachhour_import`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_vnso_full_eachhour_import` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=12413373 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:42:02
