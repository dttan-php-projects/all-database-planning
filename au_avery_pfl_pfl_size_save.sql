...
--
-- Table structure for table `pfl_size_save`
--

DROP TABLE IF EXISTS `pfl_size_save`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pfl_size_save` (
  ...
  PRIMARY KEY (`so_line`,`size`,`order`)
...
-- Dump completed on 2022-03-26 21:35:10
