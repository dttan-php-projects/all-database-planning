...
--
-- Table structure for table `prd_ord_track_fapl_plan_data`
--

DROP TABLE IF EXISTS `prd_ord_track_fapl_plan_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prd_ord_track_fapl_plan_data` (
  ...
  `ups_num` int(3) DEFAULT NULL,
  `material` varchar(25) DEFAULT NULL,
  `color` varchar(10) DEFAULT NULL,
  `sheet` int(4) DEFAULT NULL,
...
-- Dump completed on 2022-03-26 21:47:45
