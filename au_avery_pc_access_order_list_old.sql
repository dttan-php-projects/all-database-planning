...
--
-- Table structure for table `access_order_list_old`
--

DROP TABLE IF EXISTS `access_order_list_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `access_order_list_old` (
...
) ENGINE=InnoDB AUTO_INCREMENT=10159660 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:38:15
