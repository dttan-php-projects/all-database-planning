...
--
-- Table structure for table `oracle_download_test`
--

DROP TABLE IF EXISTS `oracle_download_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `oracle_download_test` (
...
-- Dump completed on 2022-03-26 21:33:30
