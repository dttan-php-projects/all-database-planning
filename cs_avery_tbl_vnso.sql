...
CREATE TABLE `tbl_vnso` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_tbl_vnso_CUST_PO_NUMBER` (`CUST_PO_NUMBER`),
  KEY `idx_tbl_vnso_ORDER_NUMBER_LINE_NUMBER` (`ORDER_NUMBER`,`LINE_NUMBER`)
) ENGINE=InnoDB AUTO_INCREMENT=27244789 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:44:28
