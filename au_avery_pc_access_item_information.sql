...
--
-- Table structure for table `access_item_information`
--

DROP TABLE IF EXISTS `access_item_information`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `access_item_information` (
  ...
  `StringCut_ComboTag` varchar(100) DEFAULT NULL,
  `FirstOrder` varchar(100) DEFAULT NULL,
  `Inactive_Reason` varchar(100) DEFAULT NULL,
  `CheckReplaceMaterial` varchar(5) DEFAULT '0',
  `Brand_Protection` varchar(45) DEFAULT '0',
  `Updated_By` varchar(95) DEFAULT NULL,
  `Updated_Date` timestamp NULL DEFAULT NULL,
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `GLID_UNIQUE` (`GLID`),
  KEY `INDEX` (`GLID`)
) ENGINE=InnoDB AUTO_INCREMENT=32315115 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:39:13
