...
--
-- Table structure for table `vnso_size_oe`
--

DROP TABLE IF EXISTS `vnso_size_oe`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vnso_size_oe` (
  ...
  `ID_INSERT` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2022-03-26 21:36:55
