...
--
-- Table structure for table `planning_request_date_ic`
--

DROP TABLE IF EXISTS `planning_request_date_ic`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `planning_request_date_ic` (
...
-- Dump completed on 2022-03-26 21:50:34
