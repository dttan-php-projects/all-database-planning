...
--
-- Table structure for table `tbl_vnso_cam_full`
--

DROP TABLE IF EXISTS `tbl_vnso_cam_full`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_vnso_cam_full` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=81952046 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:42:58
