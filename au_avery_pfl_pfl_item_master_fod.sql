...
--
-- Table structure for table `pfl_item_master_fod`
--

DROP TABLE IF EXISTS `pfl_item_master_fod`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pfl_item_master_fod` (
...
-- Dump completed on 2022-03-26 21:35:21
