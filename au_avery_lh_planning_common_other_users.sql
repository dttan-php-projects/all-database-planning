...
--
-- Table structure for table `common_other_users`
--

DROP TABLE IF EXISTS `common_other_users`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `common_other_users` (
...
-- Dump completed on 2022-03-26 21:52:02
