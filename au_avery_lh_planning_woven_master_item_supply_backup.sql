...
--
-- Table structure for table `woven_master_item_supply_backup`
--

DROP TABLE IF EXISTS `woven_master_item_supply_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `woven_master_item_supply_backup` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `machine_type` varchar(20) DEFAULT NULL,
  `internal_item` varchar(45) DEFAULT NULL,
  `length_btp` varchar(5) DEFAULT NULL COMMENT 'Chiều dài thành phẩm',
  `code_name` varchar(45) DEFAULT NULL COMMENT 'Mã vật tư',
  ...
  `order` int(11) DEFAULT NULL COMMENT 'Thứ tự code vật tư (code vật tư thứ ???)',
...
-- Dump completed on 2022-03-26 21:51:57
