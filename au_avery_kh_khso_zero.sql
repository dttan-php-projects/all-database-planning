...
--
-- Table structure for table `khso_zero`
--

DROP TABLE IF EXISTS `khso_zero`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `khso_zero` (
  ...
  PRIMARY KEY (`ID`),
  KEY `SOLINE` (`Line_Number`,`Order_Number`)
) ENGINE=InnoDB AUTO_INCREMENT=22881738 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:41:51
