...
--
-- Table structure for table `khso_kht_ooh`
--

DROP TABLE IF EXISTS `khso_kht_ooh`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `khso_kht_ooh` (
  ...
  `BILL_TO_CUSTOMER` varchar(999) DEFAULT NULL,
  `SHIP_TO_CUSTOMER` varchar(999) DEFAULT NULL,
  `ORDER_TYPE` varchar(45) DEFAULT NULL,
  `SALES_MAN` varchar(450) DEFAULT NULL,
  ...
  `LINE_SUBIN` varchar(45) DEFAULT NULL,
  `LINE_STATUS` varchar(150) DEFAULT NULL,
  `LINE_CS` varchar(45) DEFAULT NULL,
  `TRIM_TE` varchar(45) DEFAULT NULL,
  `LINE_SOURCE` varchar(450) DEFAULT NULL,
  `PO_VENDOR` varchar(450) DEFAULT NULL,
  ...
  `SALE_CODE` varchar(450) DEFAULT NULL,
  `ITEM_CODE` varchar(450) DEFAULT NULL,
  `CUSTOMER_ITEM` varchar(450) DEFAULT NULL,
...
-- Dump completed on 2022-03-26 21:41:54
