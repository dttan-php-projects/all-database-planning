...
--
-- Table structure for table `tbl_vnso_9h_full`
--

DROP TABLE IF EXISTS `tbl_vnso_9h_full`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_vnso_9h_full` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=76049148 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:43:35
