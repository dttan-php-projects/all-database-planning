...
--
-- Table structure for table `tbl_sip_file`
--

DROP TABLE IF EXISTS `tbl_sip_file`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_sip_file` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13152908 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:44:22
