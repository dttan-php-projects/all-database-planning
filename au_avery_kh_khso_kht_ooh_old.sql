...
--
-- Table structure for table `khso_kht_ooh_old`
--

DROP TABLE IF EXISTS `khso_kht_ooh_old`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `khso_kht_ooh_old` (
...
) ENGINE=InnoDB AUTO_INCREMENT=36835 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:41:36
