...
--
-- Table structure for table `vnso_total`
--

DROP TABLE IF EXISTS `vnso_total`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vnso_total` (
  ...
  `BOOKED_DATE` varchar(45) DEFAULT NULL,
  ...
  `DELIVERY_UPDATE_DATE` varchar(100) DEFAULT NULL,
  ...
  `DJ_CREATION_DATE` varchar(45) DEFAULT NULL,
  `SCHEDULE_GROUP_NAME` varchar(45) DEFAULT NULL,
  `RELEASED_DATE` varchar(45) DEFAULT NULL,
  `SCHEDULED_COMPLETION_DATE` varchar(100) DEFAULT NULL,
  ...
  `PROMISE_DATE_2` varchar(45) DEFAULT NULL,
  ...
  `VIRABLE_BREAKDOWN_INSTRUCTIONS` varchar(3000) DEFAULT NULL,
  `MFG_NOTE` varchar(999) DEFAULT NULL,
  `PRODUCTION_METHOD` varchar(999) DEFAULT NULL,
  `EINVOICE_STATUS` varchar(45) DEFAULT NULL,
  `VIETTEL_EINVOICE` varchar(45) DEFAULT NULL,
  `CUSTOMER_STORE` varchar(45) DEFAULT NULL,
  `CUSTOMER_EMAIL` varchar(100) DEFAULT NULL,
  `CUSTOMER_EMAIL_CC` varchar(100) DEFAULT NULL,
  `SHIPPING_INSTRUCTIONS` varchar(999) DEFAULT NULL,
  ...
  PRIMARY KEY (`ID`),
  KEY `SEARCH_SO` (`ORDER_NUMBER`,`LINE_NUMBER`),
  KEY `GLID` (`ITEM`),
  KEY `D` (`D`),
  KEY `ORDER_NUMBER` (`ORDER_NUMBER`),
  KEY `SHIPTO` (`SHIP_TO_CUSTOMER`),
  KEY `BILLTO` (`BILL_TO_CUSTOMER`),
  KEY `SOLDTO` (`SOLD_TO_NUMBER`),
  KEY `G` (`ORDER_NUMBER`,`LINE_NUMBER`,`SHIPMENT_NUMBER`),
  KEY `PACKING_INSTRUCTIONS` (`PACKING_INSTRUCTIONS`),
  KEY `shipping_instruction` (`SHIPPING_INSTRUCTIONS`)
) ENGINE=InnoDB AUTO_INCREMENT=923901685 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:36:14
