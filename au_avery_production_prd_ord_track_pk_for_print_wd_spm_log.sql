...
CREATE TABLE `prd_ord_track_pk_for_print_wd_spm_log` (
  ...
  `contract_no` varchar(25) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `item` varchar(40) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `stf_po` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
...
-- Dump completed on 2022-03-26 21:46:34
