...
--
-- Table structure for table `tbl_adidas_fabric_test_py_test`
--

DROP TABLE IF EXISTS `tbl_adidas_fabric_test_py_test`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_adidas_fabric_test_py_test` (
  ...
  `CSSales` varchar(45) DEFAULT NULL,
  `Season` varchar(45) DEFAULT NULL,
  `Brand` varchar(45) DEFAULT NULL,
  `LabelAppliedBy` varchar(45) DEFAULT NULL,
  `NumOfReport` varchar(50) DEFAULT NULL,
  ...
  `ActualLeadtime` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2022-03-26 21:42:28
