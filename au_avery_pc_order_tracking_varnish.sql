...
--
-- Table structure for table `order_tracking_varnish`
--

DROP TABLE IF EXISTS `order_tracking_varnish`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_tracking_varnish` (
  ...
  PRIMARY KEY (`ID`),
  KEY `JJ` (`JOBJACKET`)
) ENGINE=InnoDB AUTO_INCREMENT=91915 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:38:44
