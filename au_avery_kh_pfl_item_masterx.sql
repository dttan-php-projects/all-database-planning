...
--
-- Table structure for table `pfl_item_masterx`
--

DROP TABLE IF EXISTS `pfl_item_masterx`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pfl_item_masterx` (
  `ID` int(11) NOT NULL AUTO_INCREMENT,
  `Item_Code` varchar(45) DEFAULT NULL,
  `Material_Code` varchar(45) DEFAULT NULL,
  `Ink` varchar(45) DEFAULT NULL,
  `NumInk` varchar(450) DEFAULT NULL,
  `Print_Type` varchar(100) DEFAULT NULL,
  `Cut_Type` varchar(100) DEFAULT NULL,
  `Fold_Type` varchar(100) DEFAULT NULL,
...
-- Dump completed on 2022-03-26 21:40:56
