...
--
-- Table structure for table `common_size_save`
--

DROP TABLE IF EXISTS `common_size_save`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `common_size_save` (
  ...
  `so_cai_size` int(5) DEFAULT NULL,
  ...
  PRIMARY KEY (`so_line`,`size`,`color`)
...
-- Dump completed on 2022-03-26 21:52:18
