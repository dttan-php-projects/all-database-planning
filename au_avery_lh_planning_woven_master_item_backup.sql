...
--
-- Table structure for table `woven_master_item_backup`
--

DROP TABLE IF EXISTS `woven_master_item_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `woven_master_item_backup` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `machine_type` varchar(20) DEFAULT NULL COMMENT 'Loại máy WV/CW/LB',
...
-- Dump completed on 2022-03-26 21:52:53
