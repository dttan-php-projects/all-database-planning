...
--
-- Table structure for table `order_tracking_print`
--

DROP TABLE IF EXISTS `order_tracking_print`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `order_tracking_print` (
  ...
  PRIMARY KEY (`ID`),
  KEY `JJ` (`JOBJACKET`)
) ENGINE=InnoDB AUTO_INCREMENT=9075074 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:39:24
