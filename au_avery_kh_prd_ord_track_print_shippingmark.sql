...
CREATE TABLE `prd_ord_track_print_shippingmark` (
  ...
  `box` varchar(5) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `virable_instr` varchar(5000) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `del_sts` varchar(1) CHARACTER SET utf8 NOT NULL COMMENT 'trang thai binh thuong , bu',
...
-- Dump completed on 2022-03-26 21:41:46
