...
--
-- Table structure for table `prd_auto_schedule_mst`
--

DROP TABLE IF EXISTS `prd_auto_schedule_mst`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `prd_auto_schedule_mst` (
  ...
  `tot_time` int(11) DEFAULT NULL,
  PRIMARY KEY (`product_line_code`,`so_line`)
...
-- Dump completed on 2022-03-26 21:48:04
