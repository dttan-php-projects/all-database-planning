...
--
-- Table structure for table `shippingmark_rbo_print`
--

DROP TABLE IF EXISTS `shippingmark_rbo_print`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `shippingmark_rbo_print` (
...
-- Dump completed on 2022-03-26 21:37:46
