...
--
-- Table structure for table `cs_confirmpromise`
--

DROP TABLE IF EXISTS `cs_confirmpromise`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cs_confirmpromise` (
  ...
  KEY `IndexID` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2186711 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:43:38
