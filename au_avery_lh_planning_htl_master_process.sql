...
--
-- Table structure for table `htl_master_process`
--

DROP TABLE IF EXISTS `htl_master_process`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `htl_master_process` (
  ...
  PRIMARY KEY (`internal_item`,`process`,`order`)
...
-- Dump completed on 2022-03-26 21:52:42
