...
--
-- Table structure for table `master_bom_closed20200226`
--

DROP TABLE IF EXISTS `master_bom_closed20200226`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `master_bom_closed20200226` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1246980 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:32:57
