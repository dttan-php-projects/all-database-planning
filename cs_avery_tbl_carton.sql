...
CREATE TABLE `tbl_carton` (
  ...
  `CartonKgQty` longtext,
  `inputdate` datetime DEFAULT NULL,
  `row_index` bigint(20) DEFAULT NULL,
  `Box` varchar(5000) DEFAULT NULL,
  `PNK` varchar(500) DEFAULT NULL,
  `PathFile` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_tbl_carton_SO` (`SO`),
  KEY `TEXT` (`row_index`)
) ENGINE=InnoDB AUTO_INCREMENT=20484772146 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:44:09
