...
CREATE TABLE `tbl_shipment` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_tbl_shipment_ORDER_NUMBER_LINE_NUMBER` (`ORDER_NUMBER`,`LINE_NUMBER`)
) ENGINE=InnoDB AUTO_INCREMENT=1294772 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:42:55
