...
--
-- Table structure for table `bs_master_item_backup`
--

DROP TABLE IF EXISTS `bs_master_item_backup`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `bs_master_item_backup` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `internal_item` varchar(85) NOT NULL,
  `rbo` varchar(125) DEFAULT NULL,
  `material_code` varchar(65) NOT NULL,
  `material_desc` varchar(155) DEFAULT NULL,
  `cbs` int(1) NOT NULL,
  `scrap` float DEFAULT NULL,
  `sales_pic` varchar(55) DEFAULT NULL,
...
-- Dump completed on 2022-03-26 21:50:49
