...
--
-- Table structure for table `tbl_vnso_2020`
--

DROP TABLE IF EXISTS `tbl_vnso_2020`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tbl_vnso_2020` (
...
) ENGINE=InnoDB AUTO_INCREMENT=17192307 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:42:34
