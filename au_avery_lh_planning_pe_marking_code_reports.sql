...
--
-- Table structure for table `pe_marking_code_reports`
--

DROP TABLE IF EXISTS `pe_marking_code_reports`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `pe_marking_code_reports` (
  ...
  PRIMARY KEY (`production_line`,`markingCode`)
...
-- Dump completed on 2022-03-26 21:52:50
