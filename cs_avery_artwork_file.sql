...
--
-- Table structure for table `artwork_file`
--

DROP TABLE IF EXISTS `artwork_file`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `artwork_file` (
  `FullPath` varchar(600) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=2147476237 DEFAULT CHARSET=utf8;
...
-- Dump completed on 2022-03-26 21:44:25
